export default [
    ...
    { path: '/exchange/*', component: resolve => require(['../pages/exchange/Exchange.vue'], resolve) },
    { path: '/contract', component: resolve => require(['../pages/contract/Contract.vue'], resolve) },
	{ path: '/contract/*', component: resolve => require(['../pages/contract/Contract.vue'], resolve) },

    { path: '/crowdFunding', component: resolve => require(['../pages/crowdFunding/crowdFunding.vue'], resolve) },
    { path: '/incomeTreasure', component: resolve => require(['../pages/incomeTreasure/incomeTreasure'], resolve) },
    ...
    { path: '/ore', component: resolve => require(['../pages/Ore/ore'], resolve) },
    {
        path: '/otc',
    ...
    // },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'IEORecord',
                // component: safe,
                component: resolve => require(['../components/uc/IEORecord'], resolve),
            },
            {
                path: 'record',
                // component: record,
            ...
            },
            {
                path: 'zjjl',
                // component: meblc,
                component: resolve => require(['../components/uc/Zjjl'], resolve),
            },
            {
                path: 'wtls',
                // component: meblc,
                component: resolve => require(['../components/uc/Wtls'], resolve),
            },
            {
                path: 'jyls',
                // component: meblc,
                component: resolve => require(['../components/uc/Jyls'], resolve),
            },

            {
                path: 'IncomeTreasureRecord',
                // component: meblc,
                component: resolve => require(['../components/uc/IncomeTreasureRecord'], resolve),
            },
            {
                path: 'zhiyajiebi',
                // component: meblc,
                component: resolve => require(['../components/uc/zhiyajiebi'], resolve),
            }
    ...
    {
        path: '/currencyLending',
        component: resolve => require(['../pages/currencyLending/currencyLending'], resolve)
    },
];
