<template>
    <div class="shaow" id="lever">
        <div class="hidden-assets" style="padding-right: 5px;">
        ...
        <div class="order-table" style="margin-top: 15px;">
            <Table stripe class="pubTable table" :columns="tableColumnsMoney" :data="tableMoney" :loading="loading" :disabled-hover="true"></Table>
        </div>
