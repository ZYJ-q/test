<template>
                ...
                <section>
                    <div class="table-inner action-box">
                        ...
                        <div class="action-inner">
                            ...
                            <div class="inner-box" >
                                <div class="form-group form-address" style="display: flex" v-if="showEOS">
                                   <div class="w45" style="margin-right:20px">
                                       <label for="controlAddress" class="controlAddress describe">地址标签</label>
                                       <div class="control-input-group">
                                           <input type="text" class="EosLabelAdr" v-model="EOSLabel" placeholder="标签地址">
                                       </div>
                                   </div>
                                   <div class="w45">
                                ...
                                <div class="form-group form-address"  v-else>
                                        <label for="controlAddress" class="controlAddress describe">{{$t('uc.finance.withdraw.address')}}</label>
                                        <div class="control-input-group">
                                            <Select
                                                    :placeholder="$t('common.select')"
                        ...
                        <div class="udsdtType" v-show="showUSDT">
                            <div class="usdtTitle">请USDT类型</div>
                            <div class="flex flex-align-center selectUsdtBOx flex-pack-between">
                                <div class="selectUsdt" :class="i==curUsdtIndex?'active':''" v-for="(item,i) in usdtType" :key="i" @click="selectUsdtType(i)">{{item.name}}</div>
  ...
  <Poptip  trigger="focus" :content="$t('other.ot5')+currentCoin.minTxFee+$t('other.ot6')+currentCoin.maxTxFee" style="width: 100%;">
                                    <InputNumber
                                        v-model="withdrawFee"
...
<!--                                    </p>-->
      ...
      <div slot="footer">
        ...
        <span
            style="background:#1EBB88;color:#fff;width:80px;border-radius:30px;display:inline-block;text-align:center;height:30px;line-height: 30px;"
            @click="ok">确定</span>
      </div>
    </Modal>
  </div>
