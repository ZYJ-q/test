                ...
                <div class="rightarea-con">
                    <div class="form-group">
                        ...
                        <Button
                            type="warning"
                            @click="queryOrder"
                            style="padding: 6px 30px;margin-left:10px;background-color:#1EBB88;border-color:#1EBB88"
                        >
...
const mapEn = new Map([
    ...
    ['26', 'loan flow'],
    ['27', 'repayment flow'],
    ['28', 'Currency transfer in contract'],
    ['29', 'Contract transfer in Currency'],
    ['30', 'Contract trade'],
    ['31', 'Capital cost'],
	['45', 'Currency exchange contract'],
	['46', 'Currency transfer currency in this contract'],
]);
...
export default {
    ...
    methods: {
        ...
        getList(pageNo) {
            ...
            if (this.recordValue == 0 || this.recordValue) {
				if(this.recordValue == 32){	//币币转币本合约
					type = '45';
				}else if(this.recordValue == 33){	//币本合约转币币
					type = '46';
				}else{
    ...
    computed: {
        tableColumnsRecord() {
            ...
            columns.push({
                title: this.$t("uc.otcorder.fee"), //"应付手续费"
                width: Y,
                align: "center",
                render(h, params) {
                    return h(
