  ...
  <div class="nav-rights">
    <div class="nav-right">
      <div class="bill_box_order">
        <div class="order_box">
          <Tabs value="name2" @on-click="showItem">
            <TabPane :label="$t('uc.otcorder.paided')" name="name2">
              <div class="order-table">
                <Table class="pubTable tableBorder" :no-data-text="$t('common.nodata')" stripe :columns="tableColumnsOrder" :data="tableOrder" :loading="loading" :disabled-hover="true"></Table>
