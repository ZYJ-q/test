...
WebsockFeed.prototype.subscribeBars = function(symbolInfo, resolution, onRealtimeCallback, listenerGUID, onResetCacheNeededCallback) {
    var that = this;
    this.stompClient.subscribe('/topic/contract-market/trade/'+symbolInfo.name, function(msg) {
        // ------
    ...
    this.stompClient.subscribe('/topic/contract-market/kline/'+symbolInfo.name, function(msg) {
        // -------
        var resp = JSON.parse(msg.body);
