<template>
    <div class="login_form">
        <Spin v-show="showLoadSpin" size="large" class="wAll hAll s_spin" style="position: absolute;z-index: 100;display: flex;justify-content: center;align-items: center;"></Spin>
...
export default {
  ...
  methods: {
    ...
    emailReset () {
      ...
      params["geetest_challenge"] = '' //极验验证二次验证表单数据 chllenge
      params["geetest_validate"] = '' //极验验证二次验证表单数据 validate
      params["geetest_seccode"] = '' //极验验证二次验证表单数据 seccode
