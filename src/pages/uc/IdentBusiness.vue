  ...
  <div style="background: #ececec; padding: 81px; padding-top: 80px">
    <div class="content">
      ...
      <div style="width: 80%; margin: 0 auto; margin-bottom: 60px">
        ...
        >
          ...
          <Step
            :title="
              certStatus == 5 ? result : certStatus == 6 ? shenheshibai : passed
            "
          ></Step>
        </Steps>
        ...
        >
          ...
          <div class="fail-reason" style="margin-top: 50px; font-size: 16px">
            ...
            <span style="margin-left: 10px"
              >{{ $t("uc.identity.yuanyin") }}：{{ refuseReason }}</span
            >
          </div>
        </div>
        ...
        >
          ...
          <div class="fail-reason" style="margin-top: 50px; font-size: 16px">
            <Icon type="md-alert" color="red" size="16" />
            <span style="margin-left: 10px"
              >{{ $t("uc.identity.reason") }}：{{ certReason }}</span
            >
          </div>
        </div>
        ...
        >
          ...
          <div style="margin-top: 30px; font-size: 16px; text-align: center">
            <a @click="returnAdit" style="color: #aaa">{{
              $t("uc.identity.shenqingtuibao")
            }}</a>
          </div>
        </div>
      </div>
      ...
      <div class="ipshang" :class="certStatus != 0 ? 'applying' : ''">
        ...
        <Row style="margin-top: 40px">
          <Col span="8">
            <div class="business-function">
              <img
                alt=""
                src="../../assets/images/business_show.png"
                width="300px"
              />
              <p style="padding: 20px 0; font-weight: 600; font-size: 18px">
                {{ $t("uc.identity.seat") }}
              </p>
              <span
                style="
          ...
          <Col span="8">
            <div class="business-function">
              <img
                alt=""
                src="../../assets/images/business_service.png"
                width="300px"
              />
              <p style="padding: 20px 0; font-weight: 600; font-size: 18px">
                {{ $t("uc.identity.service") }}
              </p>
          ...
          <Col span="8">
            <div class="business-function">
              <img
                alt=""
                src="../../assets/images/business_fee.png"
                width="300px"
              />
              <p style="padding: 20px 0; font-weight: 600; font-size: 18px">
                {{ $t("uc.identity.lowfee") }}
              </p>
              <span style="font-size: 14px; color: #999">{{
                $t("uc.identity.lowfee")
              }}</span>
        ...
        <div
          v-show="certStatus === 0"
          style="text-align: center; font-size: 16px; margin-top: 50px"
        >
        ...
        <div v-show="certStatus === 0" class="sq">
          <Button
            @click="apply"
            style="background: #3399ff; color: #fff; outline: none"
      ...
      <div class="mail" v-show="isShowMailt">
        ...
        ><br />
        <Button type="info" style="margin-top: 25px; width: 297px">{{
          $t("uc.identity.confirm")
        }}</Button>
      </div>
      <!-- 邮件end -->
    </div>
    ...
    <Modal v-model="modal_read">
      ...
      <div class="apply-note">
        ...
        <p>
          {{ $t("uc.identity.second.step1c1") }}<br />{{
            $t("uc.identity.second.step1c2")
          }}
        </p>
        ...
        <div style="text-align: left; padding: 30px 0">
          ...
          <span>
            <font color="#3399ff">{{ auditText }}</font
        ...
        <Button
          ...
          "
          >{{ $t("uc.identity.second.shenqingchngweishangjia") }}</Button
        >
      </div>
      <p slot="footer">
          ...
          <Row>
            ...
            <Col span="8">
              <FormItem :label="shuliang">
                <Label v-model="apply_form.amount">{{
                  apply_form.amount
                }}</Label>
              </FormItem>
            </Col>
    ...
    <Modal v-model="modal_return" @on-ok="returnAudit">
      ...
      <p style="text-align: center; font-size: 14px">
        {{ $t("uc.identity.wufachexiao") }}
      </p>
      <p style="text-align: center; font-size: 14px">
        {{ $t("uc.identity.suredo") }}
      </p>
      <Input
