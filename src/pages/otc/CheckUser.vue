          ...
          <div class="leftmenu left-box">
            ...
            <div class="deal-market-info">
              <p v-if="user.emailVerified == 1">
                ...
                <span class="unmarket">{{
                  $t("otc.checkuser.emaildone")
                }}</span>
              </p>
              <p v-else>
                <i class="iconfont icon-youxiang"></i>
                <span class="unmarket">{{
                  $t("otc.checkuser.emailundo")
                }}</span>
              </p>
          ...
          <div class="right-safe">
            <div class="trade-right-box">
              <div class="trade-price">
                <Row class="tit">
                  <Col span="6"
                    >{{ $t("otc.checkuser.language") }}:
                    {{ $t("otc.checkuser.languagetext") }}</Col
                  >
                  <Col span="6"
                    >{{ $t("otc.checkuser.registtime") }}:
                    {{ user.createTime }}</Col
                  >
                  <Col span="6"
                    >{{ $t("otc.checkuser.exchangetimes") }}:
                    {{ user.transactions }}</Col
                  >
                </Row>
              </div>
            </div>
            <div class="trade-operation">
              <div class="trade-group merchant-top">
                ...
                <span class="tips-word"
                  >{{ user.username && user.username && strpro(user.username)
                  }}{{ $t("otc.checkuser.exchangeinfo") }}</span
                >
              </div>
            </div>
