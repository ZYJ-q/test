  ...
  <div class="content-wrap">
    <div class="container chat-in-box" id="List">
      <p style="padding: 10px 0 10px 20px; font-size: 16px">
        <router-link to="/uc/order" style="color: #3399ff">{{
          $t("otc.myorder")
        }}</router-link>
      ...
      <Row class="chat-in">
        <div class="flex flex-pack-between">
          <div>
            <div class="leftmenu left-box chat-right">
              <div class="chat-right-in">
                <h6 class="h6-flex">
                  <span v-if="tradeType == 0"
                    >{{ $t("otc.chat.seller") }}:</span
                  >
                  <span v-else>{{ $t("otc.chat.buyer") }}:</span>
                  <router-link
                    :to="{ path: '/checkuser', query: { id: msg.otherSide } }"
                  >
                ...
                <div class="bottom-btn">
                  <div style="padding-top: 20px">
                    ...
                    <div v-show="statusBtn == 2 && tradeType == 0">
                      <Button type="warning" @click="appearOrder">{{
                    ...
                    <div v-show="statusBtn == 2 && tradeType == 1">
                      ...
                      <Button @click="appearOrder" type="error">{{
          ...
          <div class="rightbox">
              ...
              >
                ...
                <p
                  v-if="
                    wechatPay &&
                    wechatPay != null &&
                    wechatPay.qrWeCodeUrl != null &&
                    wechatPay.qrWeCodeUrl != ''
                  "
                >
            ...
            <chatline :msg="msg" class="chat_fbLine"></chatline>
          </div>
        </div>
      </Row>
    </div>
...
/deep/ .chat_fbLine {
  ...
  .chat-line {
    padding: 100px 24px 30px 24px !important;
  }
}
.chat-top {
  padding: 30px 0;
