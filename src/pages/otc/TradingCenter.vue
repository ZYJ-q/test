        ...
        <Row>
          <Col span="4">
            <div class="leftmenu">
              <router-link
                to="/editad"
                style="line-height: 40px; display: block; margin: 10px"
              >
                <Button
                  class="adv"
                  type="primary"
              ...
              <ul class="nav nav-pills nav-stacked">
                <span
                  class="leftmenu-title leftmenu-folding top"
                  data-folding="trademenu1"
                >
                ...
                <li class="">
                  <router-link to="/tradingcenter/coin1buy">{{
                    $t("otc.tradecenter.buyin")
                  }}</router-link>
                </li>
                <li class="">
                  <router-link to="/tradingcenter/coin1sell">{{
                    $t("otc.tradecenter.sellout")
                  }}</router-link>
                </li>
              </ul>
            </div>
